...
import { INotificationProvider } from 'src/shared/domain/providers/notification.provider';
import { DiscordWebhookResponse, DiscordAPIError } from './types/discord.types';

@Injectable()
export class DiscordNotificationAdapter implements INotificationProvider {
